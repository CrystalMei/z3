...
namespace smt {
    ...
    struct theory_diff_logic_weak_statistics {
        ...
        theory_diff_logic_weak_statistics() {
            reset();
        }
    };

    template<typename Ext>
    class theory_diff_logic_weak : public theory, public theory_opt, private Ext {
        ...
        public:
            ...
            std::ostream& display(theory_diff_logic_weak const& th, std::ostream& out) const;
        };
        ...
        class nc_functor {
            ...
            theory_diff_logic_weak& m_super;
        public:
            nc_functor(theory_diff_logic_weak& s) : m_super(s) {}
            void reset();
        ...
        theory_diff_logic_weak_statistics   m_stats;
        Graph                          m_graph;
        bool                           m_consistent;
        ...
        struct var_value_hash {
            theory_diff_logic_weak & m_th;
            var_value_hash(theory_diff_logic_weak & th):m_th(th) {}
        ...
        struct var_value_eq {
            theory_diff_logic_weak & m_th;
            var_value_eq(theory_diff_logic_weak & th):m_th(th) {}
    ...
    public:    
        theory_diff_logic_weak(context& ctx);

        ~theory_diff_logic_weak() override {
            reset_eh();
        }
    ...
    struct weak_idl_ext {
        ...
        numeral     m_epsilon;
        weak_idl_ext() : m_epsilon(1) {}
    };

    struct weak_sidl_ext {
        static const bool m_int_theory = true;
        typedef s_integer numeral;
        typedef s_integer fin_numeral;
        numeral m_epsilon;
        weak_sidl_ext() : m_epsilon(1) {}
    };
    ...
    struct weak_rdl_ext {
        ...
        typedef rational fin_numeral;
        numeral      m_epsilon;        
        weak_rdl_ext() : m_epsilon(rational(), true) {}
    };
    ...
    //
    struct weak_srdl_ext : public weak_rdl_ext {};

    typedef theory_diff_logic_weak<weak_idl_ext>  theory_weak_idl;
    typedef theory_diff_logic_weak<weak_sidl_ext> theory_weak_fidl;
    typedef theory_diff_logic_weak<weak_rdl_ext> theory_weak_rdl;
    typedef theory_diff_logic_weak<weak_srdl_ext> theory_weak_frdl;
};
